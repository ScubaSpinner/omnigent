...
def non_git_server(
    ...
    :param using_mock_llm: Whether running against the mock LLM.
...
def _create_session(
    ...
    *,
    ...
    :param databricks_workspace_host: Workspace host URL used for model
        rewriting; ``None`` when not running against Databricks.
                    ...
                    "tool_calls": [
                        {
                            ...
                            "arguments": json.dumps(
                                {"path": filename, "content": updated_content}
                            ),
                        },
                    ],
                },
